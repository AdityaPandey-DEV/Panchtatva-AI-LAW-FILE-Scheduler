/**
 * Sidebar component - navigation stuff
 * 
 * Had to refactor this like 5 times to get the responsive design right
 * The role-based menu logic was tricky but works now
 */
  ...
  const getNavigationItems = () => {
    ...
    if (isClient()) {
      baseItems.push({
        ...
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            {/* Users icon - copied from heroicons */}
